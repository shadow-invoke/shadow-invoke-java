...
public enum Record {
    ...
    private static final Queue<Recording> QUEUE = QueueUtils.synchronizedQueue(new CircularFifoQueue<>(1024));
    private final Map<String, Schedule> invocationKeyToSchedule = new HashMap<>();
    ...
    protected void submit(Recording recording, Recorder recorder) {
        ...
        invocationKeyToSchedule.putIfAbsent(invocationKey, recorder.getSchedule());
